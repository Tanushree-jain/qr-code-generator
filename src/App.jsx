    ...
    <>
      <div className="App">
        ...
        <div className="edit-panel">
          ...
          >
            Color  & Size<span className="direction">{showColorSection ? "▲" : "▼"}</span>
          </h3>
          {showColorSection && (
      ...
      <footer className="footer">The QR spot – crafted by Tanushree with ❤️ | <a href="https://github.com/Tanushree-jain">GitHub</a> | <a href="https://www.linkedin.com/in/tanushree-gangwal">LinkedIn</a></footer>
    </>
  );
}
